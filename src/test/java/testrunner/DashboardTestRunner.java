...
public class DashboardTestRunner extends Setup {
    ...
    public void doLogin() throws IOException, ParseException {
        ...
        JSONArray empArray = Utils.readJSONList("./src/test/resources/admin.json");
    ...
    @Test(priority = 1,description = "New user successfully created by admin")
    public void createUser() throws InterruptedException, IOException, ParseException {
        ...
        Allure.description("New User Created Successfully By Admin ");
    }
...
//        softAssert.assertEquals(driver.findElements(By.className("oxd-text--h6")).get(1).getText(),"Add Employee");
    ...
    @Test(priority = 5, description = "Admin tried to create a user with a password that mismatched between the password and confirm password fields.")
